...
// poppins
export const POPPINS_REGULAR = 'poppinsregular';
export const POPPINS_MEDIUM = 'poppinsmedium';
export const POPPINS_BOLD = 'poppinsbold';
...
export const FONT_20 = scaleFont(23.5);
export const FONT_18 = scaleFont(18.5);
